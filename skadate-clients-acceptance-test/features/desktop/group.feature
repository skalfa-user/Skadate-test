Feature: Group
    ...
    Scenario: Create
        ...
        And fill in the following:
            | title                  | testGroup              |
            | description            | Super Test Group       |
        And I select checkbox question with name "Who can view" and value "[Anybody]"
        And I select checkbox question with name "Who can invite" and value "[Participants]"
        And press "Create"
        Then I should see "Group created"
