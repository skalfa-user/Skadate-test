...
class SLPREMIUMTHEME_CMP_UserCarousel extends OW_Component
{
    private $uniqId;
    ...
    public function onBeforeRender()
    {
        ...
        $staticJs = OW::getPluginManager()->getPlugin("slpremiumtheme")->getStaticJsUrl();
        OW::getDocument()->addScript($staticJs . "jcarousellite.js");
        
        $js = UTIL_JsGenerator::newInstance();
        $js->callFunction(array("Skadate", "UserCarousel"), array(
