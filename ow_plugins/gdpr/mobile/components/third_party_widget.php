...
class GDPR_MCMP_ThirdPartyWidget extends BASE_CLASS_Widget
{
    public function __construct( BASE_CLASS_WidgetParameter $params )
    {
        ...
        $this->setTemplate(OW::getPluginManager()->getPlugin('gdpr')->getMobileCmpViewDir() . 'third_party_widget.html');
    }
