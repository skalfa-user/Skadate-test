...
//TODO rename getter or setter
    ...
    public function renderInput( $params = null )
    {
        ...
        foreach ( $this->options as $key => $value )
        {
            ...
            $this->setId(UTIL_HtmlTag::generateAutoId('input_' . uniqid(UTIL_String::getRandomString(rand(8, 13), UTIL_String::RND_STR_ALPHA_NUMERIC))));$this->setId(UTIL_HtmlTag::generateAutoId('input'));
